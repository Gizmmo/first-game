...
var playState = {
	...
	create: function() {
		this.createPlayer(); //Creates a player and adds gravity
		this.createWorld(); //Create the world for the player to move around in
		this.createEnemies(); //Creates the enemies in the world
		this.createEmitter(); //Creates the particle emitter for the player death
		this.createCoin(); //Creates the coin in the game world
		this.createScore(); //Creates the score label
		this.createKeyInputs(); //Creates inputs for the player

		this.addPlayerAnimations(); //Adds animations to the player object

		this.addSounds(); //Adds sounds to various things
